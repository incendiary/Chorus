...
1. **Clone the repository:**
   ...
   ```bash
   git clone -b v3.1.0 https://github.com/incendiary/Chorus.git
   cd Chorus
   ```
...
```bash
docker pull ghcr.io/incendiary/chorus:v3.1.0
docker run --rm -p 8501:8501 ghcr.io/incendiary/chorus:v3.1.0
```

### GPU (NVIDIA CUDA)

```bash
docker pull ghcr.io/incendiary/chorus:v3.1.0-gpu
docker run --rm -p 8501:8501 --gpus all ghcr.io/incendiary/chorus:v3.1.0-gpu
```
